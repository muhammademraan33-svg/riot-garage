          ...
          <div className="relative flex items-center gap-0.5 sm:gap-1 md:gap-2">
            ...
            <div className="absolute -top-2 sm:-top-6 md:-top-8 -left-1 sm:-left-3 md:-left-4 z-50" style={{ pointerEvents: 'auto' }}>
              <img
                ...
                className="h-20 w-20 sm:h-36 sm:w-36 md:h-44 md:w-44 lg:h-52 lg:w-52 object-contain flex-shrink-0 drop-shadow-[0_10px_24px_rgba(0,0,0,1)]"
              />
            </div>
            ...
            <div className="relative z-10 flex-1 min-w-0 ml-2 sm:ml-0">
              <h1 
                className="text-[10px] sm:text-xl md:text-2xl lg:text-3xl font-black tracking-[0.16em] uppercase"
                style={{
                  color: '#FFFFFF',
                  textShadow: `
